classdef Wireless < handle
    ...
    methods
        ...
        %% laser states
        function obj=setLaserState(obj,sIdx,state)
            ...
            if(~islogical(state))
             ...
             obj.laserstate(sIdx)=state;
            pause(0.1);
        end
        
        function close(obj)
            obj.Stop();
            for i=1:length(obj.laserstate);
                obj.setLaserState(i,false);
            end
        ...
        function obj = setSrcPower(obj,sIdx,pwr)
            ...
            fprintf(obj.serialport, sprintf('SLE %d %2d\r',sIdx-1,pwr));%\n
